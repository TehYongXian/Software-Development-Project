                        ...
                        if(mysqli_stmt_execute($stmt)){
                          ...
                          // Check if username exists, if yes then verify password
                              if(mysqli_stmt_num_rows($stmt) == 1){
                                ...
                                mysqli_stmt_bind_result($stmt, $studentid, $name ,$email,$correct_password, $intake);
                            ...
                            if(mysqli_stmt_execute($stmt)){
                              ...
                              // Check if username exists, if yes then verify password
                                  if(mysqli_stmt_num_rows($stmt) == 1){
                                    ...
                                    // Bind result variables
                                    mysqli_stmt_bind_result($stmt, $lecturerid, $name ,$email, $correct_password, $department);
                                            if(mysqli_stmt_fetch($stmt)){
                                                    if($password == $correct_password){
                                                      // Password is correct, so start a new session
                                                      session_start();
                                ...
                                if(mysqli_stmt_execute($stmt)){
                                  ...
                                  // Check if username exists, if yes then verify password
                                      if(mysqli_stmt_num_rows($stmt) == 1){
                                        ...
                                        // Bind result variables
                                        mysqli_stmt_bind_result($stmt, $adminid, $name, $correct_password);
                                                if(mysqli_stmt_fetch($stmt)){
                                                        if($password == $correct_password){
                                                          // Password is correct, so start a new session
                                                          session_start();
                                    ...
                                    if(mysqli_stmt_execute($stmt)){
                                      ...
                                      // Check if username exists, if yes then verify password
                                          if(mysqli_stmt_num_rows($stmt) == 1){
                                            ...
                                            // Bind result variables
                                            mysqli_stmt_bind_result($stmt, $parentid, $name, $phone, $correct_password);
                                                    if(mysqli_stmt_fetch($stmt)){
                                                            if($password == $correct_password){
                                                              // Password is correct, so start a new session
                                                              session_start();
